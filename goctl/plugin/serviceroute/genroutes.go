...
func Register{{.serviceName}}Handlers(server *rest.Server, serverCtx *svc.ServiceContext) {
	{{.routesAdditions}}
}
`
...
rest.WithPrefix("%s"),`, g.prefix)
	...
	routeFilename = api.Service.Name + routeFilename + ".go"
	...
	return genFile(fileGenConfig{
		...
		data: map[string]any{
			...
			"serviceName":     strings.ToUpper(api.Service.Name[:1]) + api.Service.Name[1:],
		},
	})
}
